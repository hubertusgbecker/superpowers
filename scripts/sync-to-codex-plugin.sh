...
Upstream commit: https://github.com/hubertusgbecker/superpowers/commit/$UPSTREAM_SHA
...
Upstream: https://github.com/hubertusgbecker/superpowers/commit/$UPSTREAM_SHA
Branch:   $SYNC_BRANCH"
